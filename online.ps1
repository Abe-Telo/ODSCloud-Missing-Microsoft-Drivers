...
$SurfaceLaptop4Amd = "https://raw.githubusercontent.com/Abe-Telo/ODSCloud-Missing-Microsoft-Drivers/blob/main/SurfaceLaptop4Amd/Surface_Laptop_4_Amd.ps1"
...
if ($sku -eq "Surface_3_Nag") {
    ...
    Invoke-Expression (Invoke-WebRequest -Uri $SurfaceLaptop4Amd -UseBasicParsing).Content
